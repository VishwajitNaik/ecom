    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-center h-full">
        <div className="text-center text-white px-4 max-w-4xl">
          ...
          <h1
            ref={titleRef}
            className="text-2xl md:text-5xl lg:text-7xl font-bold mb-3 md:mb-6 leading-tight drop-shadow-2xl"
          >
            {currentSlideData.title}
          </h1>

          {/* Subtitle - Hidden on small mobile, shown on larger screens */}
          <p
            ref={subtitleRef}
            className="hidden md:block text-xl md:text-2xl mb-4 md:mb-8 leading-relaxed drop-shadow-lg max-w-2xl mx-auto opacity-95"
          >
            {currentSlideData.subtitle}
          </p>
