...
//     <>
//       {showLogin && (
//         <PhoneOtpLogin onSuccess={handleLoginSuccess} onClose={() => setShowLogin(false)} />
//       )}
//     <div
//       ref={productRef}
...
//             className="flex-1 bg-gray-400 text-white py-2 px-2 rounded-lg
...
const Product = ({ product, index, onBuyNow }) => {
  ...
  const handleCardClick = () => {
    if (isMobileView) {
      // For mobile, we'll show product modal
