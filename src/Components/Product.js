  ...
  return (
    <>
      ...
      <div 
        ...
        hover:shadow-lg hover:scale-105 transition-all duration-300 overflow-hidden
      ...
      >
        ...
        <div className="h-32 lg:h-48 overflow-hidden">
          <Image
            src={product.images?.[0] || '/api/placeholder/300/150'}
            alt={product.name}
            width={300}
            height={150}
            className="w-full h-full object-cover hover:scale-110 transition-transform duration-500"
        ...
        <div className="p-3 lg:p-6">
          ...
          {/* Quantity Selector - Hidden on mobile, shown on desktop */}
          ...
          >
            <div className="p-4 lg:p-6">
              ...
              <div className="flex justify-between items-start mb-4 lg:mb-6">
                <h2 className="text-xl lg:text-2xl font-bold text-gray-800">{product.name}</h2>
                <button 
                  onClick={closeMoreInfo}
                  className="text-gray-400 hover:text-gray-600 text-2xl transition-colors duration-300"
                >
